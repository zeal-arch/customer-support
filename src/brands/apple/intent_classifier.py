...
class IntentClassifier:
    ...
    - ngram_range=(1,2)  : captures multi-word phrases like "won't turn on", "app store refund"
    - max_features=80k   : wider vocabulary for rare product/issue terminology
    - class_weight='balanced' : compensates for ios_software_bug class imbalance (63% of corpus)
    - C=2.0              : optimized regularisation parameter for balanced precision/recall
    """
