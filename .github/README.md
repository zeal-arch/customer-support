...
|---|---|---|---|
| Trivial baseline (majority class) | 0.704 | 0.0918 | 0.7600 |
| Simple baseline (rule-based + TF-IDF) | 0.504 | 0.5603 | 0.7160 |
| **Our Agent (Hybrid Precedence + LR + TF-IDF)** | **1.0000** | **1.0000** | **0.9360** |

*Highlights*: Achieved **100% Intent Accuracy (250/250)** and **1.0000 Macro-F1** with **93.6% Escalation Accuracy** (TN=189, FP=1, FN=15, TP=45; only 1 false positive over-escalation). Full pipeline reproduces in < 20 seconds.
